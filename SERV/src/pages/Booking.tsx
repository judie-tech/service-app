...
import { Calendar, Clock, MapPin, CreditCard, ChevronRight, ChevronLeft, Shield, DollarSign } from 'lucide-react';
      ...
      case 1:
        return (
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-2xl font-semibold text-purple-800">Service Details</h2>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {frequencies.map(freq => (
                    ...
                    >
                      ...
                      {freq.discount > 0 && (
                        <div className="text-sm opacity-90">Save {freq.discount}%</div>
                      )}
                    </button>
                  ))}
                </div>
              ...
              <div>
                <label className="block text-gray-700 mb-2">Extra Services</label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {extras.map(extra => (
                    <button
                      key={extra.id}
      ...
      case 2:
        return (
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-2xl font-semibold text-purple-800">Schedule Service</h2>
      ...
      case 3:
        return (
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-2xl font-semibold text-purple-800">Location & Details</h2>
      ...
      case 4:
        return (
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-2xl font-semibold text-purple-800">Review & Payment</h2>
            
            <div className="space-y-6">
              <div className="bg-purple-50 p-6 rounded-lg space-y-4">
                <h3 className="font-semibold text-purple-800 text-lg">Booking Summary</h3>
                ...
                <div className="space-y-2 text-gray-600">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {propertySizes.find(s => s.id === bookingDetails.propertySize)?.name}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Frequency:</span>
                    <span className="font-medium">
                      {frequencies.find(f => f.id === bookingDetails.serviceFrequency)?.name}
                    </span>
                  </div>
              ...
              <div className="space-y-4">
                <h3 className="font-semibold text-purple-800 text-lg">Payment Details</h3>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-8">
            {['Service Details', 'Schedule', 'Location', 'Payment'].map((title, index) => (
              <div
                key={title}
