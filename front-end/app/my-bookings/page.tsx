                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-purple-600">{booking.provider}</span>
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600">Service on: {booking.date}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Clock className="h-4 w-4 text-gray-500" />
                      <span className="text-gray-600">Service on: {booking.time}</span>
                    </div>
                  </div>
                </div>
              </div>
